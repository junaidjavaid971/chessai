...
class FragmentTrainingPiecesChessboard : Fragment(), ChessBoardListener {
        ...
        val simpleItemTouchCallback =
            object : ItemTouchHelper.SimpleCallback(
                ...
                override fun onMove(
                    ...
                    Collections.swap(trainingChessboardAdapter.arrayList, oldPos[0], newPos[0])
    ...
    private fun moveItem(oldPos: Int, newPos: Int) {
        val temp: Int = trainingChessboardAdapter.arrayList.get(oldPos)
        trainingChessboardAdapter.arrayList[oldPos] =
            trainingChessboardAdapter.arrayList[newPos]
        trainingChessboardAdapter.arrayList[newPos] = temp
        trainingChessboardAdapter.notifyItemChanged(oldPos)
        trainingChessboardAdapter.notifyItemChanged(newPos)
    }
}